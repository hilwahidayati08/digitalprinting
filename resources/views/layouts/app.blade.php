    ...
    <div class="min-h-screen flex">
        ...
        <div class="flex-1 flex flex-col md:ml-0 w-full">
            ...
            <main class="flex-1 p-4 md:p-6 bg-gray-50">
                ...
                @if(isset($_paginator) && $_paginator instanceof \Illuminate\Pagination\LengthAwarePaginator && $_paginator->hasPages())
    @include('partials.admin.pagination', ['items' => $_paginator])
@endif
            </main>
