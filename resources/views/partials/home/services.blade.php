    ...
    <div class="max-w-7xl mx-auto px-5 sm:px-6 md:px-8 lg:px-12">
        <div class="text-center mb-10 md:mb-12">
            <span class="inline-flex items-center gap-2 px-5 py-2.5 bg-white rounded-full shadow-lg border border-neutral-100 mb-6">
                ...
                <span class="text-xs sm:text-sm font-bold tracking-[0.2em] text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-800 uppercase">
                    LAYANAN UNGGULAN
                </span>
            </span>
            <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold text-neutral-800 mb-4 leading-tight">
                Solusi Printing <span class="text-blue-600">Lengkap</span> untuk Semua Kebutuhan
            </h2>
            <p class="text-neutral-600 text-sm sm:text-base max-w-2xl mx-auto px-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-6">
            @forelse($services as $service)
                <div class="bg-white rounded-xl p-5 md:p-6 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100 group text-center sm:text-left">
                    ...
                    <h3 class="text-base md:text-lg font-bold text-gray-800 mb-2 group-hover:text-blue-600 transition-colors">
