...
@section('title', 'Keranjang Belanja - CetakKilat')
        ...
        <div class="flex items-center py-4 gap-2">
            <div class="flex items-center gap-2 text-primary-600">
                <div class="w-5 h-5 rounded-full bg-primary-600 flex items-center justify-center">
                    <i class="fas fa-shopping-cart text-[8px] text-white"></i>
                </div>
            ...
            <div class="flex items-center gap-2 text-neutral-400">
                <div class="w-5 h-5 rounded-full bg-neutral-100 flex items-center justify-center">
                    <i class="fas fa-clipboard-check text-[8px]"></i>
                </div>
...
<section class="py-10 bg-gray-50 min-h-screen">
    <div class="container mx-auto px-4 max-w-6xl">
        ...
        <div class="max-w-md mx-auto text-center py-16 px-6 bg-white border border-neutral-100 rounded-[1.5rem] shadow-sm">
            ...
            <a href="{{ route('products') }}" class="inline-flex px-8 py-3 bg-neutral-900 hover:bg-primary-600 text-white font-black rounded-xl text-[10px] uppercase tracking-widest transition-all">Lihat Produk</a>
        </div>
